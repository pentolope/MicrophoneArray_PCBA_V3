...
def assess(record):
    ...
    classes["board-connectivity"] = {
        ...
        "detail": "judged over the board-required net set, which is "
                  "the only set that decides connectivity",
    }
