...
from research.freshness import FreshnessError         # noqa: E402
...
def _tempdir(name):
    ...
    import shutil
    import tempfile
    path = tempfile.mkdtemp(prefix="research_" + name.replace("-", "_") + "_")
